...
class Users with ChangeNotifier {
  List<User> _users = [
    User(
        id: 1,
        userName: 'DarthMaul123',
        name: "Maul",
        dob: '',
        profession: '',
        major: '',
        intro: "My name is Maul !",
        imgUrl: 'assets/images/maul.png',
        bio: 'KENOBIII!!!!'),
    User(
        id: 2,
        userName: 'HelloThere123',
        name: "Obi-wan",
        dob: '',
        profession: '',
        major: '',
        intro: "My name is Obi-wan!",
        imgUrl: 'assets/images/obiwan.jpg',
        bio: 'The negotiations were short'),
    User(
        id: 3,
        userName: 'TheChosenOne123',
        name: "Anakin",
        dob: '',
        profession: '',
        major: '',
        intro: "My name is Anakin !",
        imgUrl: 'assets/images/anakin.png',
    ...
    User(
        ...
        profession: '',
        major: '',
        intro: "My name is Grogu !",
        imgUrl: 'assets/images/baby_yoda.jpg',
        bio: 'goo goo gaga'),
  ];
